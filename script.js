...
const items = [
  ...
  { img:'stickers/faraway.png',    text:'I love how cute you are, even when you’re far away 🌏💕' },
  { img:'stickers/day.png',        text:'I love when you tell me about your day ☀️🗣' },
  ...
  { img:'stickers/tiktok.png',     text:'I love that you spend time responding to all my TikToks 📱❤️' },
  { img:'stickers/notnpc.png',     text:'I love how you’re not an NPC 😂' },
  { img:'stickers/openup.png',     text:'I love when you open up to me' },
  { img:'stickers/smile.png',      text:'I love how you make me smile every second we’re on a call together 😄' },
  { img:'stickers/coolstuff.png',  text:'I love how you always spend time making super cool stuff for me like the book, the clay animals, and the hoodie 🦖📚🧸' },
  { img:'stickers/texts.png',      text:'I love how we text all day and never run out of things to say 📱✨' },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function handleLove() {
    ...
    setTimeout(() => {
      ...
      // measure & avoid header/envelope/clear-btn
